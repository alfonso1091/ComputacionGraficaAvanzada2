...
void applicationLoop() {
	...
	while (psi) {
		...
		for(int i = 0; i< lamp1Position.size(); i++){
			...
			shaderMulLighting.setVectorFloat3("pointLights["+ std::to_string(i) + "].ligth.specular", glm::value_ptr(glm::vec3(0.6, 0.48, 0.03)));
			...
			shaderTerrain.setVectorFloat3("pointLights["+ std::to_string(i) + "].ligth.specular", glm::value_ptr(glm::vec3(0.6, 0.48, 0.03)));
